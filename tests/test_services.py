...
def rounding_test_data():
    return [{"operation_date": "2023-01-01", "amount": 1712.0}, {"operation_date": "2023-01-02", "amount": 123.0}]
...
def test_find_phone_transactions(sample_transactions):
    ...
    test_data = [{"description": "Payment +7 921 123-45-67"}, {"description": "No phone here"}]
